...
import { aggregateMessageKeysNotFromMe, generateWAMessageContent, generateWAMessageFromContent, assertMediaContent, assertMeId, bindWaitForEvent, decryptMediaRetryData, DEF_MEDIA_HOST, encodeNewsletterMessage, encodeSignedDeviceIdentity, encodeWAMessage, encryptMediaRetryRequest, extractDeviceJids, generateMessageIDV2, generateParticipantHashV2, generateWAMessage, getStatusCodeForMediaRetry, getUrlFromDirectPath, getWAUploadToServer, MessageRetryManager, normalizeMessageContent, parseAndInjectE2ESessions, unixTimestampSeconds } from '../Utils/index.js';
...
import GiftedStatus from './gcstatus.js';
export const makeMessagesSocket = (config) => {
    ...
    const giftedStatus = new GiftedStatus({ generateWAMessageContent, generateWAMessageFromContent }, waUploadToServer, relayMessage, config, sock);
